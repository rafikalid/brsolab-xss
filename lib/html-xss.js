...
const	VOID_TAGS	= ['img', 'br', 'hr', 'input', 'area', 'col', 'command', 'embed', 'keygen', 'link', 'meta', 'param', 'source', 'track', 'wbr', 'base'],
		BLACKLIST	= ['script', 'input', 'link', 'meta', 'base', 'style', 'iframe', 'frame', 'head'];
...
function clean(html, options){
	...
	html	= HtmlParser.parse(html, (tagName, tagNameLC, tagBody, startPosition, lastPosition, innerHTML) => {
		try{
			...
			// user operations
				tagInfo	= {tagNameLC, tagBody, isEndTag, isSingleTag, hasSingleTagMark, startPosition, lastPosition, isBlackListed};
				Object.defineProperty(tagInfo, 'tagName', {value : tagName});
				Object.defineProperty(tagInfo, '_options', {value : options});
			// innerHTML
